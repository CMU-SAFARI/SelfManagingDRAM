...
configs["smd_ref_policy"]=VariableRefresh # variable rate refresh ("VariableRefresh") or fixed rate refresh ("FixedRate")
configs["smd_variable_refresh_weak_row_percentage"]="0.1" # the proportion of retention-weak rows among all rows simulated
...
configs["smd_rh_protection_mode"]="PARA" # deterministic ("Graphene") or probabilistic ("PARA") RowHammer protection

configs["smd_ecc_scrubbing_enabled"]=true # enable/disable ECC scrubbing (SMD-MS)
